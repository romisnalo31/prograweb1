<?php 
  define('BASEURL','http://localhost:8080/prograweb1/xeon');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
            ...
            <div id="navbar" class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="../site/inicio.php"><i class="icon-home"></i></a></li>
						<li><a href="../revista/revista.php">Revista</a></li>
                        <li><a href="../articulo/articulo.php">Art&iacute;culo</a></li>
                        <li><a href="../autor/autor.php">Autor</a></li>
                        <li><a href="../status/status.php">Estatus</a></li>
                    </ul>
                </div>
            </div>
        </div>
