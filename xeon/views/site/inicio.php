        ...
        <div class="container">
            <div class="box">
                ...
                <ul class="portfolio-filter">
                    ...
                    <li><a class="btn btn-primary" href="#" data-filter=".bootstrap">2 y 3</a></li>
                    <li><a class="btn btn-primary" href="#" data-filter=".html">5 a 8</a></li>
                    <li><a class="btn btn-primary" href="#" data-filter=".wordpress">3, 4, 6 y 8</a></li>
                </ul><!--/#portfolio-filter-->
